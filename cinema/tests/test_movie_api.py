...
class UnauthenticatedMovieApiTests(TestCase):
    ...
    def test_list_movies(self):
        """Test retrieving a list of movies without authentication"""
        sample_movie()
    ...
    def test_retrieve_movie_detail(self):
        """Test retrieving movie detail without authentication"""
        movie = sample_movie()
    ...
    def test_create_movie_auth_required(self):
        """Test that authentication is required for creating movie"""
        payload = {
            "title": "Test movie",
...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_retrieve_movie_detail(self):
        ...
        movie.actors.add(Actor.objects.create(first_name="Tom", last_name="Cruise"))
